...
| LLM04 Data & Model Poisoning | Output is grounded in fetched sources: every citation must quote its source verbatim or it is dropped; adversarial fixture proves the guardrail | `verify_citations`, `tests/fixtures/adversarial_page.html` |
